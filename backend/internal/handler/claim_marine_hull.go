...
func NewMarineHullClaimHandler(repo claim.MarineHullClaimRepository, upload domain.UploadRepository) *MarineHullClaimHandler {
	return &MarineHullClaimHandler{repo: repo, upload: upload}
}
