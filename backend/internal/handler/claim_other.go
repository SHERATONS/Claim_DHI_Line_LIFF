...
func NewOtherClaimHandler(repo claim.OtherClaimRepository, upload domain.UploadRepository) *OtherClaimHandler {
	return &OtherClaimHandler{repo: repo, upload: upload}
}
