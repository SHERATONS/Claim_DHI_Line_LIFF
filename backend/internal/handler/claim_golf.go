...
func NewGolfClaimHandler(repo claim.GolfClaimRepository, upload domain.UploadRepository) *GolfClaimHandler {
	return &GolfClaimHandler{repo: repo, upload: upload}
}
...
type golfClaimForm struct {
	...
	GolferName       string `form:"golferName"`
