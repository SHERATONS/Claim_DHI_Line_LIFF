...
ENV_FILE="$SCRIPT_DIR/deploy_uat.env"
...
deploy_backend() {
  ...
  # Generate a temporary YAML file for environment variables to handle spaces/special characters
  ENV_VARS_FILE="$SCRIPT_DIR/backend/env_vars.yaml"
