...
const MOCK_POLICY_DATA = {
    policyNumber: '14025-123-170001231',
...
export default function ClaimForm() {
    ...
    const validateForm = (): boolean => {
        const result = droneSchema.safeParse({ ...values });
        if (result.success) {
            setErrors({});
            return true;
        }
    ...
    if (submitState.success) {
        const contactEmail = getContactEmail('drone');
        return (
            <SuccessScreen
        ...
        <>
            ...
            <div className="header-section">
                ...
                <div style={{ fontSize: '0.95rem', marginTop: 5 }}>
                    แจ้งเคลม อากาศยาน (Aviation) หรือ เครื่องบินเล็ก หรือ (Drone) (สอบถามข้อมูลเพิ่มเติม กรุณาติดต่อ Call Center 1736)
                </div>
            </div>
            ...
            <div className="form-container">
                <form onSubmit={handleSubmit} noValidate>
                    ...
                    <PersonalDocumentUpload
                        ...
                        instructions={[
                            '- รูปถ่ายโดรนที่เสียหาย/ที่เกิดเหตุ',
                            '- รูปถ่ายหมายเลขเครื่อง (Serial Number)',
                            '- ใบอนุญาตผู้บังคับโดรน',
                            '- ใบทะเบียนโดรน (กสทช.)',
                        ]}
                    />
